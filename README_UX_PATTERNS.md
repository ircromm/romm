...
**Note:** The detailed UX pattern docs are archived with an `OLD_` prefix. Use them as historical reference only.

### Documents Included

1. **OLD_WINDOWS_EXPLORER_UX_PATTERNS.md** (Main Reference)
...
2. **OLD_WINDOWS_EXPLORER_PATTERNS_QUICK_REFERENCE.md**
...
3. **OLD_UX_PATTERNS_IMPLEMENTATION_GUIDE.md**
...
4. **OLD_UX_PATTERNS_VISUAL_MOCKUPS.md**
