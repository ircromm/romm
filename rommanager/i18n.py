...
_TRANSLATIONS = {
    LANG_EN: {
        ...
        "new_session_confirm_save": "Do you want to save current progress before starting a new session?",
        "title_main": "R0MM",
        "title_launcher": "R0MM",
    ...
    LANG_PT_BR: {
        ...
        "new_session_confirm_save": "Deseja salvar o progresso atual antes de iniciar uma nova sessão?",
        "title_main": "R0MM",
        "title_launcher": "R0MM",
        ...
        "tip_add_dat": "Adiciona um arquivo DAT XML à lista de correspondência ativa.",
